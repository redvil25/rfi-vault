    ...
    <div className="mx-auto max-w-4xl px-6 py-8">
      <header className="mb-6">
        ...
        <p className="mt-1 max-w-2xl text-sm text-muted">
          Upload a CTIS request-for-information export as a PDF. Fields are extracted by a
          deterministic parser — no model is involved, so nothing can be invented. You
          review every consideration before anything is written to the repository.
        </p>
      </header>
